...
static ngx_int_t ngx_http_example_handle_pre_conf(ngx_conf_t *cf);
static ngx_int_t ngx_http_example_handle_init(ngx_conf_t *cf);
...
static ngx_command_t ngx_http_example_handle_commands[] = {
    ...
    { ngx_string("hello_allow"),
      ...
      NGX_HTTP_LOC_CONF_OFFSET,
      offsetof(ngx_http_example_handler_loc_conf_t, allow),
      NULL },
...
static ngx_http_module_t ngx_http_example_handle_ctx = {
    ngx_http_example_handle_pre_conf,
    ngx_http_example_handle_init,
...
static ngx_int_t
ngx_http_example_handle_pre_conf(ngx_conf_t *cf)
{
    debug_print_str("lifecycle: ngx_http_example_handle_pre_conf");
    return NGX_OK;
}

static ngx_int_t
ngx_http_example_handle_init(ngx_conf_t *cf)
{
    debug_print_str("lifecycle: ngx_http_example_handle_init called");
    ...
    *h = ngx_http_example_handle_access_handler;
